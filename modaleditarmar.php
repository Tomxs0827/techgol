<div class="modal fade" id="modaleditarmar<?php echo $marca['id_marca'];?>"
     tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><b>Editar Marca</b></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form action="editarmar.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <label><b>Nombre</b></label>
                    <input type="text" name="nombre" class="form-control mb-2"
                           value="<?php echo $marca['nombre'];?>" required>
                    <label><b>Descripción</b></label>
                    <textarea name="descripcion" class="form-control mb-2" 
                              rows="3"><?php echo $marca['descripcion'];?></textarea>
                    ...
                    <select name="activo" class="form-select">
                        <option value="1" <?php echo $marca['activo']==1 ? 'selected' : ''; ?>>Sí</option>
                        <option value="0" <?php echo $marca['activo']==0 ? 'selected' : ''; ?>>No</option>
                    </select>
                </div>
